...
Route::post('/customer-store', [CheckoutsController::class, 'signupStore'])->name('signup.store');
...
Route::group(['middleware' => ['auth', 'admin']], function(){
    ...
    Route::prefix('profiles')->group(function(){
        ...
        Route::get('/change-password', [ProfilesController::class, 'editPassword'])->name('user.change.password');
        Route::post('/update-password', [ProfilesController::class, 'updatePassword'])->name('user.update.password');
    });
    ...
    Route::prefix('customers')->group(function(){
        ...
        Route::post('/customers/delete', [CustomersController::class, 'delete'])->name('customers.draft.delete');
    });
    ...
    Route::prefix('orders')->group(function(){
        ...
        Route::get('/approved/list', [OrdersController::class, 'approvedList'])->name('admin.order.approved');
