              ...
              <div class="card-body">
                  <form action="{{ route('admin.product.store') }}" method="post" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                          <textarea rows="2" name="short_desc" id="short_desc" class="form-control">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                          <textarea rows="2" name="long_desc" id="long_desc" class="textarea">
                    ...
                    <div class="form-group row">
                      <label for="image" class="col-sm-2 col-form-label">Sub Image</label>
                      <div class="col-sm-5">
...
$(document).ready(function () {
  ...
  $('#myForm').validate({
    ...
    messages: {
      ...
      short_desc: {
        required: "Please enter a Product Short Descritpion"
      },
      long_desc: {
        required: "Please enter a Product Long Descritpion"
      },
      price: {
        required: "Please enter a Product Price"
      },
      image: {
        required: "Please enter a Product Image",
