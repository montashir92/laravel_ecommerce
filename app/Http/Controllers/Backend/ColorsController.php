...
class ColorsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pages.colors.index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.colors.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $colors->name = $request->name;
        $colors->save();
        return redirect()->route('admin.colors')->with('toast_success', 'Color Updated Successfully');
    }
